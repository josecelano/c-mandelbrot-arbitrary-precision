...
* mandelbrot-black-on-white-256x256.ppm (Mandelbrot image with Black on White color map)
* mandelbrot-white-on-black-256x256.ppm (Mandelbrot image with White on Back color map)
* mandelbrot-colored-periods-256x256.ppm (Mandelbrot image with colored periods)

and these ASCII graphs:
* mandelbrot-at-sign-256x256.txt (Mandelbrot ASCII version)
* mandelbrot-iterations-256x256.txt (Mandelbrot with number of iterations taken for point outside)
* mandelbrot-full-iterations-256x256.txt (Mandelbrot with number of iterations taken for all points)
