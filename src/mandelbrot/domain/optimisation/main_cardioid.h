#ifndef C_MANDELBROT_ARBITRARY_PRECISION_MAIN_CARDIOID_H
#define C_MANDELBROT_ARBITRARY_PRECISION_MAIN_CARDIOID_H
...
#endif //C_MANDELBROT_ARBITRARY_PRECISION_MAIN_CARDIOID_H
