...
int render_ppm_image_command(config_t *config, resolution_t resolution, char *left_bottom_zx, char *left_bottom_zy,
                             char *top_right_zx, char *top_right_zy, color_map_t color_map, char *output_file_path);
