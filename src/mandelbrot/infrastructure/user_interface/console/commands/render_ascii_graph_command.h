...
int render_ascii_graph_command(config_t *config, resolution_t resolution, char *left_bottom_zx, char *left_bottom_zy,
                               char *top_right_zx, char *top_right_zy, ascii_map_t ascii_map, char *output_file_path);
